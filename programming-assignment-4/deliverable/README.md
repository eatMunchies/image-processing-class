...
Welcome to my fourth programming assignment for CS 474, Image Processing. 

This project is structured into four executables, one for each problem of the assignment:
1. Experiment1
2. Experiment2
3. Experiment3
4. Experiment4

To run the code, simply try running the executable for that problem (./Experiment1). 
